...
import DepositIcon from "assets/studio/Deposit.svg";

const DATA = [
  { label: "Last Deposit", value: "1D Ago" },
  { label: "Total Deposits", value: "$XXXX" },
  { label: "Deposit History", value: "$XXXX" },
  { label: "Total AUM", value: "$XXXX" },
];

const TOP_CARDS = [
  { color: "#5BC983", title: "Estimated APY", value: "14%" },
  {
        ...
        <div className="flex justify-between gap-5">
          <div className="flex justify-between bg-cards py-4 px-4 rounded-xl w-6/12">
            <div>
              ...
              <p className="mt-5 text-body_dark_dark">Deposited</p>
            </div>

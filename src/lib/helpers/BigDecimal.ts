...
import { insertDecimal } from 'lib/clients/insertDecimals';

export const BN_18_STRING = (1e18).toString();
export const SCALE = BigNumber.from(BN_18_STRING);
...
export class BigDecimal {
  ...
  toReadable(): string {
    let input = insertDecimal(this.exact, this.decimals.toString());
